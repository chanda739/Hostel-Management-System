...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2017 at 03:06 PM
...
--
CREATE DATABASE IF NOT EXISTS `bit_girls_hostel` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `bit_girls_hostel`;
